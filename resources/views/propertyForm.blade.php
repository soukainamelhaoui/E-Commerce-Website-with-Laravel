...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-5 first-text">
            <h1 class="text-left">Add Your Property</h1>
            <p class="text-left">Be a part of our website and put your property for rent.</p>
        </div>
            ...
            <div class="card second-text">
                ...
                @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input type="number" min=0.01 step=0.01 id="price" name="price" class="form-control" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input type="number" min=0 id="avrooms" name="avrooms" class="form-control" required>
                        </div>
                    </div>
